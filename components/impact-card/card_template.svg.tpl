<svg xmlns="http://www.w3.org/2000/svg" width="640" height="$HEIGHT" viewBox="0 0 640 $HEIGHT" role="img" aria-label="Open Source Impact Card — $USER">
  ...
  <text x="600" y="$FOOTER_Y2" text-anchor="end" font-family="'Segoe UI',Helvetica,Arial,sans-serif" font-size="10" letter-spacing="1.5" fill="$DIM">impact-card · v1.3.0</text>
</svg>
