...
def main():
    ...
    try:
        ...
        nums = "".join(
            ...
            % (x, th.FONT, pal["gold_bright"], th.esc(v), x, th.FONT, pal["muted"], th.esc(label), x, pal["gold"])
        ...
        svg = (
            ...
            % (
                ...
                pal["line"],
                orbit(320, 170, 300, 70, -6, pal) + orbit(320, 170, 300, 70, 6, pal) + orbit(320, 170, 300, 52, 0, pal),
                nums,
                276, th.FONT, pal["dim"],
            )
        )
